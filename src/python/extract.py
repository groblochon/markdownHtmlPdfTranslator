...
class MarkdownPDFExtractor(PDFExtractor):
    ...
    def extract(self):
        try:
            ...
            self.logger.info(
                f"Markdown content has been saved to {self.pdf_path}/{self.pdf_filename}.md"
            )
    ...
    def extract_markdown(self):
        ...
        try:
            ...
            for page_num, page in enumerate(doc):
                ...
                markdown_content += page_content + "<||WXb23TXrUn3Rxz00yNNr89HV||>"
    ...
    def save_markdown(self, markdown_content):
        ...
        try:
            ...
            with open(
                f"{self.pdf_path}/{self.pdf_filename}.md",
                "w",
                encoding="utf-8",
            ) as f:
